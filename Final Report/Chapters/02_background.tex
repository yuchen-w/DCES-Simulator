...
The simulation will be design as a Multi-Agent System (MAS). MASes are...
In multi-agent simulation systems the MAS is used as a model to simulate some real-world domain.
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=1]{Images/Presage.jpg}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=1]{Images/Presage2.jpg}
